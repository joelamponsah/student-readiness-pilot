...
### Interpretation
- Published KPI data stays strict and only keeps `verified_complete` rows by default.
- `unknown_but_usable` rows are not treated as completed; they are only available in diagnostic/proxy views when the active policy allows them.
